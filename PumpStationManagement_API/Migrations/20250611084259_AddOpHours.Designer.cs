...
namespace PumpStationManagement_API.Migrations
{
    ...
    [Migration("20250611084259_AddOpHours")]
    partial class AddOpHours
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PumpStationManagement_API.Models.PumpStatusBackup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PumpStationManagement_API.Models.PumpStatusBackup", b =>
                {
                    b.HasOne("PumpStationManagement_API.Models.Pump", "Pump")
                        .WithOne()
                        .HasForeignKey("PumpStationManagement_API.Models.PumpStatusBackup", "PumpId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
